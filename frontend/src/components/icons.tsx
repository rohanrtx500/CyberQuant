...
const baseIcon = (paths: React.ReactNode) => {
  return function Icon({ className = "w-4 h-4", ...props }: IconProps) {
    return (
      <svg
...
export const CheckSquare = baseIcon(
  <>
...
export const ArrowDownRight = baseIcon(
  <>
    <path d="m7 7 10 10" />
    <path d="M17 7v10H7" />
  </>
...
export const ArrowUpRight = baseIcon(
  <>
    <path d="M7 17 17 7" />
    <path d="M7 7h10v10" />
  </>
...
export const Minus = baseIcon(<line x1="5" x2="19" y1="12" y2="12" />);

export const ChevronRight = baseIcon(<path d="m9 18 6-6-6-6" />);
...
export const DollarSign = baseIcon(
  <>
...
export const AlertOctagon = baseIcon(
  <>
...
export const HelpCircle = baseIcon(
  <>
    <circle cx="12" cy="12" r="10" />
...
export const ExternalLink = baseIcon(
  <>
    <path d="M15 3h6v6" />
    <path d="M10 14 21 3" />
