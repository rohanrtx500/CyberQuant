...
Double-click [`run_cyberquant.bat`](file:///D:/SIH%202026/Cyberquant%20AI/run_cyberquant.bat) or run in terminal:
```powershell
cd "D:\SIH 2026\Cyberquant AI"
.\run_cyberquant.bat
```
...
**Backend (FastAPI):**
```powershell
cd "D:\SIH 2026\Cyberquant AI\backend"
...
**Frontend (Next.js):**
```powershell
cd "D:\SIH 2026\Cyberquant AI\frontend"
npm run dev
